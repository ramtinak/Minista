...
namespace Minista.Views.Infos
{
    public sealed partial class HashtagView : Page
    {
        ...
        private void OnLVTopLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (S1 != null)
            {
                //S1.ChangeView(null, 12, null, true);
                S1.VerticalScrollMode = ScrollMode.Disabled;
                S1.VerticalScrollBarVisibility = ScrollBarVisibility.Hidden;
        ...
        private void OnLVRecentLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (S2 != null)
            {
                S2.VerticalScrollMode = ScrollMode.Disabled;
                S2.VerticalScrollBarVisibility = ScrollBarVisibility.Hidden;
